...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 30) { 
            	client.sendText(chat.id, `maaf member nya cuma ${totalMem}, Kalo mau invite bot, minimal jumlah mem ada 30`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
